...
import com.rgt.config.JwtConfigurationProperties;
...
public class JwtUtils {
    ...
    public String generateAccessToken(final RegisterUserEntity user) {
        Map<String, Object> claims = new HashMap<>();
        claims.put("account_creation_timestamp", user.getCreatedOn());
    ...
    public String generateRefreshToken(final RegisterUserEntity user) {
        Map<String, Object> claims = new HashMap<>();
